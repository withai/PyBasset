...
class Basset(nn.Module):
    ...
    def __init__(self):
        ...
        self.layer4 = nn.LSTM(input_size=10, hidden_size=10, num_layers=2, batch_first=True, dropout=0.3, bidirectional=True)

        self.fc1 = nn.Linear(in_features=4000, out_features=1000)
        self.relu4 = nn.ReLU()
...
def main():
    ...
    for epoch in range(max_epochs):
        ...
        torch.save({
            ...
            'auc_train': auc_train,
            'auc_test': auc_test,
            'running_loss': running_loss}, 'models_lamborghini_rnn_bidirectional_LSTM/pybasset_{0:03d}.pwf'.format(epoch))
